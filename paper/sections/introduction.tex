...
uses haplotype features in a random-forest framework.
...
reducing the demographic misspecification risk that Peede et al.~\citeyear{peede2025review}
...
(5~Mb per replicate, msprime~\citep{kelleher2018efficient}),
